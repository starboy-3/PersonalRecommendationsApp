...
def insert_shop(name: str, rating: float, cursor: psycopg2.extensions.cursor):
    ...
    return cursor.fetchone() # returns inserted shop
...
def insert_product(name: str, brand: str, description: str, category: str, price: int, shop_name: str, cursor: psycopg2.extensions.cursor): # !!! Только в рублях !!!
...
def insert_product_by_seller_id(name: str, brand: str, description: str, category: str, price: int, seller_id: int, cursor: psycopg2.extensions.cursor): # !!! Только в рублях !!!
    cursor.execute(
        """
